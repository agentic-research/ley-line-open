...
infer it from `v0.17.0`. The ordinary open `leyline daemon` command remains a
...
The current release is `v0.17.0`. It publishes platform binaries, FFI
staticlibs, and the Apache-2.0 Go schema module at
`clients/go/leyline-schema/v0.17.0`. See
...
curl -fsSLO https://github.com/agentic-research/ley-line-open/releases/download/v0.17.0/capnpc-schema-bridge-zod-darwin-arm64
...
`localhost/leyline:v0.17.0` (equivalently `ley-line-open:v0.17.0`). It uses
...
to `ghcr.io/agentic-research/ley-line-open:v0.17.0`, with a
...
```bash
docker pull ghcr.io/agentic-research/ley-line-open:v0.17.0
gh attestation verify oci://ghcr.io/agentic-research/ley-line-open:v0.17.0 \
