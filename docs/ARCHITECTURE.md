...
| Distroless OCI image | `task image` — produces `ley-line-open:0.11.3` (~20 MB) via krust + cargo-zigbuild static musl; image default CMD is `daemon --mcp-port 8384 --mcp-bind 0.0.0.0` |
